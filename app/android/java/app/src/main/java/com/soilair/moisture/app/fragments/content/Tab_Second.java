...
//
//                /**
//                 * object.getString(SQLite.JSON_WAKTU_SENSOR_SUHU) = ambil waktu suhu
//                 * object.getString(SQLite.JSON_DATA_SENSOR_SUHU) = ambil data suhu
//                 * object.getString(SQLite.JSON_WAKTU_SENSOR_KELEMBABAN) = ambil data kelembaban
//                 * object.getString(SQLite.JSON_DATA_SENSOR_KELEMBABAN) = ambil data kelembaban
//                 */
//
//                entries_suhu.add(new Entry(i, object.getInt(SQLite.JSON_DATA_SENSOR_SUHU)));
//                entries_lmbb.add(new Entry(i, object.getInt(SQLite.JSON_DATA_SENSOR_KELEMBABAN)));
//            }
//
...
//                        .sendPostRequest(SQLite.URL_POST_DATABASE, params);
//
//                return hasil;
//            }
//
