    ...
    private void showJson() {
        ...
        try {
            ...
            for (int i=0; i < result.length(); i++) {
                ...
                String waktu_suhu = object.getString(DataBase.JSON_WAKTU_SENSOR_SUHU);
                String data_suhu = object.getString(DataBase.JSON_DATA_SENSOR_SUHU);
                String waktu_kelembaban = object.getString(DataBase.JSON_WAKTU_SENSOR_KELEMBABAN);
                String data_kelembaban = object.getString(DataBase.JSON_DATA_SENSOR_KELEMBABAN);
    ...
    private void getJson () {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String hasil = sqlRequest.sendPostRequest(DataBase.URL_POST_DATABASE, params);
                return hasil;
            }
